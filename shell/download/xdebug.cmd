...
powershell -Command "(Get-Content %phpPath%\php.ini) + \"`nzend_extension=xdebug`nxdebug.mode=off`nxdebug.start_with_request=trigger`nxdebug.client_host=127.0.0.1`nxdebug.client_port=9003\" | Out-File -Encoding \"UTF8\" %phpPath%\php.ini"
