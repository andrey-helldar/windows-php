...
powershell -Command "(Get-Content %phpPath%\php.ini) + \"`nzend_extension=xdebug`nxdebug.mode=debug`nxdebug.start_with_request=yes`nxdebug.client_host=127.0.0.1`nxdebug.client_port=9003\" | Out-File -Encoding \"UTF8\" %phpPath%\php.ini"
